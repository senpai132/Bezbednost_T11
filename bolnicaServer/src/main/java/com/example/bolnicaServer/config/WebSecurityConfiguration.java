...
import com.example.bolnicaServer.security.auth.RestAuthenticationEntryPoint;
import com.example.bolnicaServer.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers("/dummy/template");
        //web.ignoring().antMatchers(HttpMethod.POST,"/dummy/person");
        //web.ignoring().antMatchers("/api/device");
